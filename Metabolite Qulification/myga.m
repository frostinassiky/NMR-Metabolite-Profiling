...
VarMin=eps+zeros(VarSize);%lb(settings.num+1:end);         % Lower Bound of Variables
VarMax=para.size_minishift;%ub(settings.num+1:end);         % Upper Bound of Variables
...
if 1%UseRouletteWheelSelection
