...
% % % 
% % % nVar=settings.num_peak;            % Number of Decision Variables
% % % 
% % % VarSize=[nVar 1];   % Size of Decision Variables Matrix
% % % 
% % % VarMin=lb(settings.num+1:end);         % Lower Bound of Variables
% % % VarMax=ub(settings.num+1:end);         % Upper Bound of Variables
...
for it=1:20%MaxIt
    ...
    disp(['Iteration ' num2str(it) ': Best Cost = ' num2str(BestCost(it)) ': Best Position = ' num2str(GlobalBest.Position)]);
